...
export default function Page() {
  ...
  const View = isDeveloper && screen === 'twin' ? Heal : { twin: Twin, heal: CodeReview, brain: Brain, leaderboard: Leaderboard, integrations: () => <Integrations userId={user.id} />, components: () => <ComponentHub isDeveloper={isDeveloper} developerTrusted={developerTrusted} onGrantDeveloperTrust={() => setDeveloperTrusted(true)} /> }[screen] || Twin
