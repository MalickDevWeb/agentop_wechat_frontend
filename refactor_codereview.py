...
# Rechercher la fonction CodeReview et la remplacer
old_function_regex = r'function CodeReview\(\) \{.*?(?=function \w+\(|export default)'

new_function = """function CodeReview() {
...
content = re.sub(old_function_regex, new_function, content, flags=re.DOTALL)
